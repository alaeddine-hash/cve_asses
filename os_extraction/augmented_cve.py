...
from augmented_cve_genai import default_serializer
...
def main():
    ...
    cves = get_filtered_cves(2024, 2024, 1)  # Adjust the parameters as needed
    ...
    for cve in cves:
        ...
        with open('cves_augmented_gpt.json', 'w') as f:
